...
def main():
    ...
    client = Client( dashboard_address = ':44594', n_workers = 6, threads_per_worker = 2 ) #scheduler_address=':37243'
    ...
    for i in range(10):
        ...
        compute = retry_unfinished_tasks(compute,df_dict,metadata_store,p_uuid_df)        
    ...
    for _,mdrow in metadata_store.iterrows(): 
        ...
        past_ts = dask.delayed(myForecast)(df, start,end,tuning_results, mdrow, "mae")
...
def myForecast(df, start,end,tuning_results,
               row, score):
...
def retry_unfinished_tasks( compute,df_dict,metadata_store,p_uuid_df ): 
